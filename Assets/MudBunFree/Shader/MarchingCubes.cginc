...
#ifndef MUDBUN_MARCHING_CUBES
#define MUDBUN_MARCHING_CUBES
...
#define MARCHING_CUBES(                                                        \
  center, size, sdf, sdf_normal, iBrushMask, smoothNormal, cubeMat,            \
  ...
  {                                                                            \
    ...
    {                                                                          \
      ...
      {                                                                        \
        ...
        SDF_NORMAL(aVertNorm[jVert], aVertPos[jVert], sdf_normal, iBrushMask, 5e-3f); \
