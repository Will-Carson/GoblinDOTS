	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord9 = vertexToFrag11_g25;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 vertexToFrag11_g25 = IN.ase_texcoord9;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 vertexToFrag11_g25 = Emission5_g25;
				o.ase_texcoord4 = vertexToFrag11_g25;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 vertexToFrag11_g25 = IN.ase_texcoord4;
...
/*ASEBEGIN
Version=18100
-1816;85;1682;872;663.6565;1231.233;1.700729;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;29;384,-640;Inherit;True;Property;_MainTex;Albedo;7;0;Create;False;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.SamplerNode;193;768,-544;Inherit;True;Property;_TextureSample4;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A6E39A6202400ED57596E8315E4FBE56B002ED61