...
public class TestClayxelMeshCollider : MonoBehaviour
{
    ...
    void FixedUpdate(){
        ...
        int levelOfDetail = 50;
        Mesh mesh = this.clayxel.generateMesh(levelOfDetail);
        
        // mesh.RecalculateNormals(); // if you want to see the mesh lit
        
        // finally we set the mesh and use it as collider, we could as well just use the a collider and keep visualizing clayxels
