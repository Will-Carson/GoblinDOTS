	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord11 = vertexToFrag6_g83;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 vertexToFrag6_g83 = IN.ase_texcoord11;
				...
				float AlphaClipThreshold = ( lerpResult4_g225 + -1E-16 );
				float3 BakedGI = 0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 vertexToFrag6_g83 = Emission4_g83;
				o.ase_texcoord6 = vertexToFrag6_g83;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 vertexToFrag6_g83 = IN.ase_texcoord6;
...
/*ASEBEGIN
Version=18100
-1862;140;1682;872;1390.612;1042.605;1.931897;True;False
...
ASEEND*/
//CHKSM=448FA4B2B09FCD817D6701D9FD186BDFAB212938