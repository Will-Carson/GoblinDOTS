...
namespace MudBun
{
  ...
  public class MudLockedMeshRenderer : MonoBehaviour, ISerializationCallbackReceiver
  {
    ...
    [ConditionalField("m_renderMode", MudRendererBase.RenderModeEnum.Splats, Min = 0.0f, Max = 5.0f)] public float SplatSize = 1.0f;
    [ConditionalField("m_renderMode", MudRendererBase.RenderModeEnum.Splats, Min = 0.0f, Max = 360.0f)] public float SplatRotation = 0.0f;
    [ConditionalField("m_renderMode", MudRendererBase.RenderModeEnum.Splats, Min = 0.1f, Max = 10.0f)] public float SplatRotationNoisiness = 1.0f;
    [ConditionalField("m_renderMode", MudRendererBase.RenderModeEnum.Splats, Min = 0.0f, Max = 1.0f)] public float SplatCameraFacing = 0.0f;
    ...
    )
    {
      ...
      SplatRotation = renderer.SplatRotation;
    ...
    {
      MudRendererBase.PopulateShaderConstantId();
      ...
      m_renderMaterialProps.SetFloat(MudRendererBase.Const.SplatRotation, SplatRotation * MathUtil.Deg2Rad);
      m_renderMaterialProps.SetFloat(MudRendererBase.Const.SplatRotationNoisiness, SplatRotationNoisiness);
