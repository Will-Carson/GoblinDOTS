...
Shader "Mud Standard Mesh (HDRP)"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_AlphaCutoutThreshold1("Alpha Cutout Threshold", Range( 0 , 1)) = 0
		_Dithering1("Dithering", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag20_g3 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag20_g3;
						...
						)
			{
				...
				float temp_output_16_3 = packedInput.ase_color.a;
				float temp_output_6_0_g4 = _AlphaCutoutThreshold1;
				float3 vertexToFrag20_g3 = packedInput.ase_texcoord5.xyz;
				float4 unityObjectToClipPos19_g3 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g3));
				float4 computeScreenPos18_g3 = ComputeScreenPos( unityObjectToClipPos19_g3 , _ProjectionParams.x );
				float4 ditherCustomScreenPos1_g4 = float4( (( computeScreenPos18_g3 / (computeScreenPos18_g3).w )).xy, 0.0 , 0.0 );
				float2 clipScreen1_g4 = ditherCustomScreenPos1_g4.xy * _ScreenParams.xy;
				float dither1_g4 = Dither8x8Bayer( fmod(clipScreen1_g4.x, 8), fmod(clipScreen1_g4.y, 8) );
				float lerpResult4_g4 = lerp( temp_output_6_0_g4 , max( temp_output_6_0_g4 , ( dither1_g4 * 0.99 ) ) , _Dithering1);
				float temp_output_14_0 = ( lerpResult4_g4 + -1E-16 );
				clip( temp_output_16_3 - temp_output_14_0);
				
				surfaceDescription.Albedo = (packedInput.ase_color).rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = packedInput.interp03.x;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = packedInput.ase_texcoord6.xyz;
				surfaceDescription.Smoothness = packedInput.interp03.y;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_16_3;

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = temp_output_14_0;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag20_g3 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord.xyz = vertexToFrag20_g3;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_16_3 = packedInput.ase_color.a;
				float temp_output_6_0_g4 = _AlphaCutoutThreshold1;
				float3 vertexToFrag20_g3 = packedInput.ase_texcoord.xyz;
				float4 unityObjectToClipPos19_g3 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g3));
				float4 computeScreenPos18_g3 = ComputeScreenPos( unityObjectToClipPos19_g3 , _ProjectionParams.x );
				float4 ditherCustomScreenPos1_g4 = float4( (( computeScreenPos18_g3 / (computeScreenPos18_g3).w )).xy, 0.0 , 0.0 );
				float2 clipScreen1_g4 = ditherCustomScreenPos1_g4.xy * _ScreenParams.xy;
				...
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = packedInput.ase_texcoord1.xy.x;
				...
				surfaceDescription.Smoothness = packedInput.ase_texcoord1.xy.y;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_16_3;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag20_g3 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord1.xyz = vertexToFrag20_g3;
					...
					)
			{
				...
				float temp_output_6_0_g4 = _AlphaCutoutThreshold1;
				float3 vertexToFrag20_g3 = packedInput.ase_texcoord1.xyz;
				float4 unityObjectToClipPos19_g3 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g3));
				float4 computeScreenPos18_g3 = ComputeScreenPos( unityObjectToClipPos19_g3 , _ProjectionParams.x );
				float4 ditherCustomScreenPos1_g4 = float4( (( computeScreenPos18_g3 / (computeScreenPos18_g3).w )).xy, 0.0 , 0.0 );
				float2 clipScreen1_g4 = ditherCustomScreenPos1_g4.xy * _ScreenParams.xy;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag20_g3 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag20_g3;
					...
					)
			{
				...
				float temp_output_6_0_g4 = _AlphaCutoutThreshold1;
				float3 vertexToFrag20_g3 = packedInput.ase_texcoord4.xyz;
				float4 unityObjectToClipPos19_g3 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g3));
				float4 computeScreenPos18_g3 = ComputeScreenPos( unityObjectToClipPos19_g3 , _ProjectionParams.x );
				float4 ditherCustomScreenPos1_g4 = float4( (( computeScreenPos18_g3 / (computeScreenPos18_g3).w )).xy, 0.0 , 0.0 );
				float2 clipScreen1_g4 = ditherCustomScreenPos1_g4.xy * _ScreenParams.xy;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				_TimeParameters.xyz = timeParameters;
				float3 vertexToFrag20_g3 = inputMesh.positionOS;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag20_g3;
						...
						)
			{
				...
				float temp_output_16_3 = packedInput.ase_color.a;
				float temp_output_6_0_g4 = _AlphaCutoutThreshold1;
				float3 vertexToFrag20_g3 = packedInput.ase_texcoord7.xyz;
				float4 unityObjectToClipPos19_g3 = TransformWorldToHClip(TransformObjectToWorld(vertexToFrag20_g3));
				float4 computeScreenPos18_g3 = ComputeScreenPos( unityObjectToClipPos19_g3 , _ProjectionParams.x );
				float4 ditherCustomScreenPos1_g4 = float4( (( computeScreenPos18_g3 / (computeScreenPos18_g3).w )).xy, 0.0 , 0.0 );
				float2 clipScreen1_g4 = ditherCustomScreenPos1_g4.xy * _ScreenParams.xy;
				...
				surfaceDescription.Emission = packedInput.ase_texcoord8.xyz;
				surfaceDescription.Smoothness = packedInput.interp03.y;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_16_3;
...
/*ASEBEGIN
Version=18100
-1862;140;1682;872;1343.684;326.4327;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-960,240;Inherit;False;Property;_AlphaCutoutThreshold1;Alpha Cutout Threshold;0;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-960,336;Inherit;False;Property;_Dithering1;Dithering;1;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;16;-960,-64;Inherit;False;Mud Generated Standard Mesh;-1;;3;7b8a07bde06607c4284a51a0d43ac96d;0;0;8;FLOAT3;0;FLOAT;3;FLOAT3;2;FLOAT;4;FLOAT;5;FLOAT3;6;FLOAT3;1;FLOAT2;7
Node;AmplifyShaderEditor.FunctionNode;14;-624,256;Inherit;False;Mud Alpha Threshold;-1;;4;926535703f4c32948ac1f55275a22bf0;0;3;8;FLOAT2;0,0;False;6;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClipNode;17;-160,-64;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=8DA7C992D6191A0E28EB6E2E59F7CFE27D7ED229